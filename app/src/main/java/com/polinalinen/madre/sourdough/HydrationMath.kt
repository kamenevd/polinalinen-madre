 ...
 *
 * Всё внутри — точные рациональные значения на `Long`: деление выполняется
 * только в конце, с `half-up` (`.5`) в пользу большего, чтобы 87.5 дало 88.
 * Это устраняет накопление погрешности при многократных кормлениях.
 */
