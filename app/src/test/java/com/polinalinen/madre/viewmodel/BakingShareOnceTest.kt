...
class BakingShareOnceTest {
    ...
    @Test
    fun `advance step does not enqueue share and finish enqueues once`() = runTest(dispatcher) {
        ...
        vm.stageBakePhoto(id, "bake_photos/photo_a.jpg")
        var exits = 0
